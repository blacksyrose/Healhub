...
$query=mysqli_query($con,"insert into contact(fullname,email,contactno,message) value('$name','$email','$mobileno','$dscrption')");
...
<header class="header">
        ...
        if (isset($_SESSION['id'])) {
            ...
            echo '
                ...
                <li>
                        <a href="hms/patient/book-appointment.php">
                            Book Appointment
                        </a>
                    </li>
                    <li>
            ...
            echo '<a href="#logins" class="btn"> Login </a>';
        }
        ?>
