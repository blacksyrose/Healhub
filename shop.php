...
<body>
    ...
    // Common back button
    echo '<a href="shop.php" class="back-button">Back</a>';
        ...
        foreach ($_SESSION['cart'] as $product_id => $quantity) {
            ...
            if (!$product_query) {
                ...
                if ($product) {
                    ...
                    echo '<td class="cart-item-name"><img src="hms/admin/uploads/' . $product['image'] . '" alt="' . $product['name'] . '" class="cart-item-image"><br>' . $product['name'] . '</td>';
    ...
    echo '</div>'; // Close cart-container
            ...
            echo '<a href="hms/patient/user-login.php" class="btn"> Login </a>';
        }
        ?>
    ...
    <div class="product-item">
        <?php
        $imagePath = 'hms/admin/uploads/' . $row['image'];
        ?>
